...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(449, 254)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.widget = QtWidgets.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(10, 10, 431, 201))
        ...
        self.widget1.setGeometry(QtCore.QRect(10, 20, 151, 161))
        ...
        self.lb_temp = QtWidgets.QLabel(self.widget1)
        font = QtGui.QFont()
        ...
        self.sB_Temp_threshold = QtWidgets.QSpinBox(self.widget1)
        self.sB_Temp_threshold.setProperty("value", 25)
        self.sB_Temp_threshold.setObjectName("sB_Temp_threshold")
        self.horizontalLayout_7.addWidget(self.sB_Temp_threshold)
        self.verticalLayout_2.addLayout(self.horizontalLayout_7)
        self.pB_play = QtWidgets.QPushButton(self.widget1)
        ...
        self.vS_temp = QtWidgets.QSlider(self.widget1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(_translate("MainWindow", "温度阈值："))
